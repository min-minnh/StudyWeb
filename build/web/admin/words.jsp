...
@media(max-width:768px){
    ...
    /* Ẩn cột No và Example trên mobile cho gọn */
...
<div class="topbar">
    ...
    <span><i class="fa-solid fa-book"></i> Manage Words</span>
</div>
...
<div class="sidebar" id="sidebar">
    ...
    <a href="vocabulary" class="active"><i class="fa-solid fa-book"></i> Vocabulary</a>
    <a href="theory"><i class="fa-solid fa-book-open"></i> Theory</a>
...
<div class="content">
    ...
    <div class="card table-wrapper">
        <table>
            ...
            <tbody>
            <%
            List<Vocabulary> list = (List<Vocabulary>) request.getAttribute("list");
            ...
            %>
                <tr><td colspan="5">No words in this topic.</td></tr>
            <%
            }
            %>
            </tbody>
